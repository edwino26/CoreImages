...
# Use e.g. [x for x in itertools.product((10,20,30,40,50,100),repeat=3)] to generate all possible layer combinations

rgr =  MLPRegressor(hidden_layer_sizes=(30, 100, 30), alpha=0.0001, batch_size='auto', learning_rate_init=0.001)
