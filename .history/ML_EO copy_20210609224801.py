...
scaler = MinMaxScaler()
T2.GRAY = T2.GRAY.rolling(5, win_type='gaussian').mean(std=3)
T6.GRAY = T6.GRAY.rolling(5, win_type='gaussian').mean(std=3)
U18.GRAY = U18.GRAY.rolling(5, win_type='gaussian').mean(std=3)
