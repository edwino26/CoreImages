...
if balance == 1:
    ...
    sns.kdeplot(test['GRAY'], label = "Ori_TEST")
    sns.kdeplot(test_smogn['GRAY'], label = "Mod_TEST")

    del train
    train = train_smogn.copy()
    del test
    test = test_smogn.copy()

train, test = train_test_split(data_smg, test_size=0.3, random_state=42)
