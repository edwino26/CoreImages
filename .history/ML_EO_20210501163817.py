...
axs[0].plot(y, y_pred_train, 'o')
axs[0].plot(y, y, 'blue'); plt.xlabel('True '+option); plt.ylabel('Predicted '+option)


axs[1].plot(y_test, y_pred_test, 'o')
axs[1].plot(y_test, y_test,  'blue')
axs[1].set_title('Training vs Test Data')
axs[1].text(0.95, 0.01, 'MSE = '+str(round(mse,2)), verticalalignment='bottom', horizontalalignment='right', transform=ax.transAxes,color='green', fontsize=10)
axs[1].text(0.95, 0.07, 'RMSE = '+str(round(rmse,2)), verticalalignment='bottom', horizontalalignment='right', transform=ax.transAxes,color='green', fontsize=10)
axs[1].plot(y, y, 'blue'); plt.xlabel('True '+option);
plt.show()
