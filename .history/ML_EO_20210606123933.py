...
#all
df_all = T2[logset].append(T6[logset]).append(U18[logset]).rename(columns={"GR_EDTC": "GR", "AT90": "logRT", "RHOZ": "RHOB", "WELL": "Well"}).set_index('Well')
...
fig.savefig('./ML_Results/'+ct+"_"+method+'.jpg')
#-------------------------------- End Lasso --------------------------
# %%
