...
rgr =  GradientBoostingRegressor(n_estimators=300, random_state=0, learning_rate=0.1, max_depth=9,loss='ls', alpha=0.9)
...
tuned_parameters = [
  ...
  {'alpha':[0.1, 0.5, 1], 'n_estimators': [1, 10, 100, 300], 'max_depth': [3, 9], 'learning_rate': [0.1, 1]},
 ]
