...
ax[0].plot(y, y_pred_train, 'o')
ax[0].plot(y, y, 'blue'); plt.xlabel('True '+option); plt.ylabel('Predicted '+option)


ax[1].plot(y_test, y_pred_test, 'o')
ax[1].plot(y_test, y_test,  'blue')
ax[1].suptitle('Training vs Test Data')
ax[1].text(0.95, 0.01, 'MSE = '+str(round(mse,2)), verticalalignment='bottom', horizontalalignment='right', transform=ax.transAxes,color='green', fontsize=10)
ax[1].text(0.95, 0.07, 'RMSE = '+str(round(rmse,2)), verticalalignment='bottom', horizontalalignment='right', transform=ax.transAxes,color='green', fontsize=10)
ax[1].plot(y, y, 'blue'); plt.xlabel('True '+option);
plt.show()


# fig = plt.figure()
# plt.subplot(121)
# plt.plot(y, y_pred_train, 'o')
# plt.plot(y, y, 'blue'); plt.xlabel('True '+option); plt.ylabel('Predicted '+option)

# ax = fig.add_subplot(122)
# plt.plot(y_test, y_pred_test, 'o')
# plt.plot(y_test, y_test,  'blue')
# plt.suptitle('Training vs Test Data')
# ax.text(0.95, 0.01, 'MSE = '+str(round(mse,2)), verticalalignment='bottom', horizontalalignment='right', transform=ax.transAxes,color='green', fontsize=10)
# ax.text(0.95, 0.07, 'RMSE = '+str(round(rmse,2)), verticalalignment='bottom', horizontalalignment='right', transform=ax.transAxes,color='green', fontsize=10)
# plt.plot(y, y, 'blue'); plt.xlabel('True '+option);
# plt.show()
#-------------------------------- End Lasso --------------------------
